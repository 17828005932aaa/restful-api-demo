...
type ServiceClient interface {
	...
	//主机详情查询
	DescribeHost(ctx context.Context, in *DescribeHostRquest, opts ...grpc.CallOption) (*Host, error)
	//主机信息修改
...
func (c *serviceClient) DescribeHost(ctx context.Context, in *DescribeHostRquest, opts ...grpc.CallOption) (*Host, error) {
	out := new(Host)
...
func (UnimplementedServiceServer) DescribeHost(context.Context, *DescribeHostRquest) (*Host, error) {
...
func _Service_DescribeHost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).DescribeHost(ctx, req.(*DescribeHostRquest))
	}
	return interceptor(ctx, in, info, handler)
}
